...
namespace LordAshes
{
    ...
    public partial class PlayerGridPlugin : BaseUnityPlugin
    {
        ...
        public const string Guid = "org.XJ_Nekomancer.plugins.PlayerGridPlugin";       // Update user name and plugin id (usually changing 'template' to name of plugin)
        ...
        /// </summary>
        /// 
        public bool bl1 = false;       
        public bool bl2 = false;
        public bool bl3 = false;
        public bool bl4 = false;
        public bool bl5 = false;
        public bool bl6 = false;
        void Awake()
        {
            ...
            RadialUI.RadialSubmenu.EnsureMainMenuItem(PlayerGridPlugin.Guid , RadialUI.RadialSubmenu.MenuType.character, "Pruebas", FileAccessPlugin.Image.LoadSprite("Magic.png"));

            RadialUI.RadialSubmenu.CreateSubMenuItem(PlayerGridPlugin.Guid,
                                                        "Light",
                                                        null,
                                                        (cid, obj, mi) => funcion1(cid),
                                                        true,
                                                        () => { return true; }
                                                    );
        ...
        void Update()
      {
            Debug.Log("Estrueofalse:" + ShowOverride.IsActive.ToString());
        ...
        void funcion1(CreatureGuid a)
        {
            Debug.Log("funcion1");
            if (PlaceableLightManager.ShowHiddenLights == false)
            {
        ...
        void funcion2(CreatureGuid a) 
        {
            Debug.Log("funcion2");
            if (bl1)
            {
                Shader.SetGlobalFloat("G_ShowOverride", Convert.ToInt32(true));
                bl1 = false;
            }
            else 
            {
        ...
        public void funcion3(CreatureGuid a) 
        {
            Debug.Log("funcion3");
            if (bl2)
            {
                Debug.Log("funcion3.1");
                ShowOverride.IsActive = true;                
                bl2 = false;
            }
            else
            {
                Debug.Log("funcion3.2");
                ShowOverride.IsActive = false;
                bl2 = true;
            }
        }
        void funcion4(CreatureGuid a) 
        {
            Debug.Log("funcion4");
            if (bl3)
            {
        ...
        void funcion5(CreatureGuid a) { }
        void funcion6(CreatureGuid a) { }
    }
}
